...
impl Mist {
    pub fn new(id: u64, cage: Cage) -> Self { Mist { id: id, cage: cage } }
    pub fn id(&self) -> u64 { self.id }
    pub fn cage(&self) -> &Cage { &self.cage }
    pub fn contains(&self, x: f32, y: f32, z: f32) -> bool { self.cage.contains(x, y, z) }
}
